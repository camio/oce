...
SET(${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES ${TOOLKIT_INCLUDE_DIRECTORIES})
FOREACH(MODULE ${TOOLKIT_MODULES})
	...
	SET(${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES ${${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES} ${${PROJECT_NAME}_SOURCE_DIR}/src/${MODULE} ${${PROJECT_NAME}_SOURCE_DIR}/drv/${MODULE})
...
IF(TOOLKIT_DEPENDS)
	FOREACH(tkit ${TOOLKIT_DEPENDS})
		SET(${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES ${${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES} ${${PROJECT_NAME}_${tkit}_INCLUDE_DIRECTORIES})
	ENDFOREACH(tkit ${TOOLKIT_DEPENDS})
	LIST(REMOVE_DUPLICATES ${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES)
ENDIF(TOOLKIT_DEPENDS)
SET(${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES ${${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES} PARENT_SCOPE)
INCLUDE_DIRECTORIES(${${PROJECT_NAME}_${TOOLKIT}_INCLUDE_DIRECTORIES})
